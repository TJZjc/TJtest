                ...
                <el-col :span="10">
                  <el-space direction="vertical" size="large">
                    <el-card>
                      ...
                      编写一个程序来判断输入的三条边能否组成三角形。通过边界值分析法来设计测试用例进行测试。
                    </el-card>
                ...
                <el-col :span="14" style="display: flex;justify-content: center">
                  <el-card style="width: 50vh;margin: 1vh">
                    ...
                    <el-form
                        ...
                        label-position="top"
                    >
                      <el-form-item label="第一条边的边长">
                        <el-input v-model.number="form.side1"/>
                      </el-form-item>
                      <el-form-item label="第二条边的边长">
                        <el-input v-model.number="form.side2"/>
                      </el-form-item>
                      <el-form-item label="第三条边的边长">
                    ...
                    <template #footer>
                      <el-form
                          ...
                          label-position="top"
                      >
                        <el-form-item label="该三角形的类型是">
                          <el-input v-model="triangleType" readonly/>
                        </el-form-item>
  ...
  methods: {
    async submitForm() {
      try {
        ...
        formData.append('l1', this.form.side1);
        formData.append('l2', this.form.side2);
        formData.append('l3', this.form.side3);
        const response = await axios.post('http://8.130.47.29:8000/triangle/', formData,{
           headers: {
        ...
        this.triangleType = response.data.result; // 假设API返回的三角形类型字段是type
      } catch (error) {
